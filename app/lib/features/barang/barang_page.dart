...
class BarangPage extends ConsumerWidget {
            ...
            (list) =>
                list.isEmpty
                    ? const SipoEmptyState(
                      ...
                      subtitle:
                          'Tambahkan barang untuk mulai mencatat transaksi.',
  ...
  void _showForm(BuildContext context, WidgetRef ref, {Barang? barang}) async {
    ...
    final hargaBeliCtrl = TextEditingController(
      text: barang?.hargaBeli.toStringAsFixed(2) ?? '',
    );
    final hargaJualCtrl = TextEditingController(
      text: barang?.hargaJual.toStringAsFixed(2) ?? '',
    );
            ...
            child: Column(
              ...
              children: [
                ...
                ValueListenableBuilder<int?>(
                  ...
                  builder:
                      (_, value, __) => DropdownButtonFormField<int>(
                        initialValue: value,
...
final _barangWithSatuanProvider = FutureProvider<List<BarangWithSatuan>>((ref) {
