      ...
      body: transaksiAsync.when(
        data: (list) => list.isEmpty
            ? const SipoEmptyState(
                ...
                subtitle: 'Tap tombol + untuk mencatat pembelian atau penjualan.',
              )
            : RefreshIndicator(
                onRefresh: () async {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: Text(
                          CurrencyFormatter.format(item.transaksi.totalHarga),
...
final _transaksiListProvider =
    FutureProvider<List<TransaksiWithDetails>>((ref) {
